...
- Food and Agriculture Organization of the United Nations (FAO), "Regenerative agriculture," FAO Family Farming Knowledge Platform.
- USDA NRCS, "Soil Health Principles" (PDF).
- USDA Farmers.gov, "Soil Health Principles and Practices."
- Rodale Institute, "What Is Organic and What Is Regenerative?"
- Savory Global, "Introduction to Holistic Decision-Making."
- Savory Global Help Center, "The basics of Holistic Management."
- Savory Global, "Holistic Planned Grazing: It's More than Rotational Grazing."
- Savory Global, "EOV - Ecological Outcome Verification."
- Savory Global, "EOV Chapter 1 Summary" (PDF).
- Savory Global, "Ecological Outcome Verification" (PDF).
- Land to Market, "EOV - Ecological Outcome Verification."
- Briske et al., "The Savory Method Can Not Green Deserts or Reverse Climate Change: A response to the Allan Savory TED video" (Rangelands, 2013) (PDF via USDA ARS).
- Briske et al., "Holistic Management: Misinformation on the Science of Grazing Management" (2014).
- Teague et al., "Deficiencies in the Briske et al. Rebuttal of the Savory Method" (2014).
- Apfelbaum et al., "Vegetation, water infiltration, and soil carbon response to Adaptive Multi-Paddock grazing..." (2022) (PDF).
- Grenke et al., "Limited impacts of adaptive multi-paddock grazing systems..." (2022).
- Döbert et al., "Adaptive multi-paddock grazing improves water infiltration..." (2021) (PDF).
