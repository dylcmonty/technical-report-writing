...
- **mapping layers** (local model and shared representation),
...
## References
- *Information Technology and Social Systems: Interoperability Notes* (internal draft).
- *mss_novelty.txt* (internal draft excerpts on semantic internet / interoperability constraints).
