...
| Phase I is a bounded feasibility study, not agronomic optimization and not proof of universal semantics | `analects/2026-00-00-phase_i-scope.md`; `analects/0000-00-00-boundary-phase_i_is_not_agronomic_optimization.md`; `omnibus/agronomic_micro_structure.md` fileciteturn15file0L1-L1 fileciteturn16file0L1-L1 fileciteturn47file0L1-L1 | FND should be judged on whether it finds a viable operational window, not on whether it solves generalized agricultural modeling. |
