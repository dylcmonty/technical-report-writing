...
## Problem setting: when information form cannot be pre-limited
...
### The Semantic Web (RDF/OWL/Linked Data)
...
### Interface contracts and schema registries (IDLs, JSON Schema, Protobuf, Avro)
...
### Syntax: self-delimitation and termination
...
### Structure: hierarchy, grouping, and composable addressing
...
### Semantics: explicit roles and interpretive cues
...
### Evolution: versioning without silent remapping
...
## Mechanisms used in self-describing grammar systems

### Mapping: local model and shared grammar
...
### Semantic diff: coordinating through explicit differences
...
## Boundaries and limits (what self-description does not solve)
...
## Example design pattern: shape-addressed hierarchical spaces (SAMRAS-style)
...
### Append-only allocation and stability
...
### Ghost positions and existential references
