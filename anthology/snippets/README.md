...
Also use critical thinking for the additional facet of who would a snippet be written to.
To explain, for a linkedin professional setting, for a scholarly setting, for an academic setting, for a website, for an email, partner developer, YC combinator, literary writtings.
...
- `catalog.json` — machine-readable index of all snippets
