...
- **PhD Student, Weill Cornell:** Pursuing a PhD in Computational Biology and Medicine.
- **Alumnus, UC Irvine:** Graduated with a degree in Computer Science.

## Key Achievements

- **USDA Grantee:** Received a $250,000 grant from the USDA’s Farmers Market Promotion Program to enhance the online presence and sales capacity for Southern California farmers.
- **Competition Winner:** First-place winner in UC Irvine’s New Venture Competition and the Butterworth Technology Startup Competition (2022).
- **Researcher:** Co-author of "Biodesign Buddy," a generative AI system for biological design education.
- **Early Innovator:** Recognized in high school for developing a protein visualization tool that won the Congressional App Challenge.

## Technical Focus

Riffle's work focuses on decentralizing agricultural solutions, moving away from reliance on large centralized platforms for market coordination. His technical contributions include:
- IoT device development for crop monitoring and insect population dynamics.
- Machine learning integration for species identification in the field.
